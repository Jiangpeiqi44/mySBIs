...
class VisionTransformer_consisv1(nn.Module):
    ...
    def forward_features(self, x):
        ...
        if self.dist_token is None:
            # 返回选中的Block
            return self.pre_logits(x[:, 0]), x_block[:,1:], attn_block
        else:
            return x[:, 0], x[:, 1]
...
class VisionTransformer_consisv2(nn.Module):
    def __init__(self, attn_list, feat_block, img_size=224, patch_size=16, in_c=3, num_classes=1000,
                 embed_dim=768, depth=12, num_heads=12, mlp_ratio=4.0, qkv_bias=True,
                 qk_scale=None, representation_size=None, distilled=False, drop_ratio=0.,
                 attn_drop_ratio=0., drop_path_ratio=0., embed_layer=PatchEmbed, norm_layer=None,
...
class VisionTransformer_consisv4(nn.Module):
    def __init__(self, attn_list, feat_block, img_size=224, patch_size=16, in_c=3, num_classes=1000,
                 embed_dim=768, depth=12, num_heads=12, mlp_ratio=4.0, qkv_bias=True,
                 qk_scale=None, representation_size=None, distilled=False, drop_ratio=0.,
                 attn_drop_ratio=0., drop_path_ratio=0., embed_layer=PatchEmbed, norm_layer=None,
...
class VisionTransformer_consisv5(nn.Module):
    def __init__(self, attn_list, feat_block, img_size=224, patch_size=16, in_c=3, num_classes=1000,
                 embed_dim=768, depth=12, num_heads=12, mlp_ratio=4.0, qkv_bias=True,
                 qk_scale=None, representation_size=None, distilled=False, drop_ratio=0.,
                 attn_drop_ratio=0., drop_path_ratio=0., embed_layer=PatchEmbed, norm_layer=None,
...
class VisionTransformer_consisv6(nn.Module):
    def __init__(self, attn_list, feat_block, img_size=224, patch_size=16, in_c=3, num_classes=1000,
                 embed_dim=768, depth=12, num_heads=12, mlp_ratio=4.0, qkv_bias=True,
                 qk_scale=None, representation_size=None, distilled=False, drop_ratio=0.,
                 attn_drop_ratio=0., drop_path_ratio=0., embed_layer=PatchEmbed, norm_layer=None,
...
def vit_base_patch16_224_in21k_consisv1(num_classes: int = 21843, has_logits: bool = True, isEmbed: bool = True, drop_ratio: float = 0.,
                                           attn_drop_ratio: float = 0., drop_path_ratio: float = 0., keepEmbedWeight: bool = True, attn_list: list = [7,8,9,10,11], feat_block: int = 6):
    model = VisionTransformer_consisv1(img_size=224,
                                          patch_size=16,
                                          embed_dim=768,
                                          depth=12,
                                          num_heads=12,
...
def vit_base_patch16_224_in21k_consisv4(num_classes: int = 21843, has_logits: bool = True, isEmbed: bool = True, drop_ratio: float = 0.,
                                           attn_drop_ratio: float = 0., drop_path_ratio: float = 0., keepEmbedWeight: bool = True, attn_list: list = [7,8,9,10,11], feat_block: int = 6):
    model = VisionTransformer_consisv4(img_size=224,
                                          patch_size=16,
                                          embed_dim=768,
                                          depth=12,
                                          num_heads=12,
...
def vit_base_patch16_224_in21k_consisv5(num_classes: int = 21843, has_logits: bool = True, isEmbed: bool = True, drop_ratio: float = 0.,
                                           attn_drop_ratio: float = 0., drop_path_ratio: float = 0., keepEmbedWeight: bool = True, attn_list: list = [7,8,9,10,11], feat_block: int = 6):
    model = VisionTransformer_consisv5(img_size=224,
                                          patch_size=16,
                                          embed_dim=768,
                                          depth=12,
                                          num_heads=12,
...
def vit_base_patch16_224_in21k_consisv6(num_classes: int = 21843, has_logits: bool = True, isEmbed: bool = True, drop_ratio: float = 0.,
                                           attn_drop_ratio: float = 0., drop_path_ratio: float = 0., keepEmbedWeight: bool = True, attn_list: list = [7,8,9,10,11], feat_block: int = 6):
    model = VisionTransformer_consisv6(img_size=224,
                                          patch_size=16,
                                          embed_dim=768,
                                          depth=12,
                                          num_heads=12,
...
class Vit_hDRMLPv2_consisv1(nn.Module):
    '''多头KQ映射 无Assemble'''
    def __init__(self, weight_pth=None, attn_list=[], feat_block=11):
        super().__init__()
        self.vit_model = vit_base_patch16_224_in21k_consisv1(
...
class Vit_hDRMLPv2_consisv2(nn.Module):
    '''第k层多头KQ映射 平均Attn用来Assemble第k层'''
    def __init__(self, weight_pth=None, attn_list=[5,6,7],feat_block=10):
        super().__init__()
...
class Vit_hDRMLPv2_consisv4(nn.Module):
    ...
    def __init__(self, weight_pth=None, attn_list=[5,6,7],feat_block=7):
        super().__init__()
        self.vit_model = vit_base_patch16_224_in21k_consisv4(
            num_classes=2, has_logits=False, isEmbed=False, keepEmbedWeight=False, attn_list=attn_list, feat_block=feat_block)
        self.custom_embed = hDRMLPv2_embed(weight_pth)
        # consis-1
        self.KQ = nn.Linear(768, 768*2)
...
class Vit_hDRMLPv2_consisv6(nn.Module):
    '''第12层多头KQ映射 平均Attn用来Assemble第k层'''
    def __init__(self, weight_pth=None, attn_list=[4,5,6,7],feat_block=11):
        super().__init__()
        self.vit_model = vit_base_patch16_224_in21k_consisv6(
            num_classes=2, has_logits=False, isEmbed=False, keepEmbedWeight=False, attn_list=attn_list, feat_block=feat_block)
        self.custom_embed = hDRMLPv2_embed(weight_pth)
        # consis-1
        self.KQ = nn.Linear(768, 768*2)

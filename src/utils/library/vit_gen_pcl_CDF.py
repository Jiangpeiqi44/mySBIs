...
class BIOnlineGeneration():
    def __init__(self,phase):
        ...
        with open('data/Celeb-DF-v2/SBI_ablation/lm_{}_clean.json'.format(phase), 'r') as f:
        ...
        # self.base_path = '../Dataset/Celeb-DF-v2/SBI_ablation/frames/'
        self.base_path = 'data/Celeb-DF-v2/SBI_ablation/frames/'
    ...
    def search_similar_face(self, this_landmark, background_face_path):
        ...
        if self.stats == 'BI':
            ...
            all_candidate_path = random.sample(self.data_list, k=1500)
